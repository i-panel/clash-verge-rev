...
请到发布页面下载对应的安装包：[Release page](https://github.com/i-panel/clash-verge-rev/releases)<br>
Go to the [release page](https://github.com/i-panel/clash-verge-rev/releases) to download the corresponding installation package<br>
