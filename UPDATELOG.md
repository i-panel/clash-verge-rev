...
- پشتیبانی از مهلت زمانی تست تاخیر سفارشی
- بهینه سازی تنظیمات مربوط به Tun

### رفع اشکالات

- خطا در عملیات ادغام
- راه اندازی مجدد سرویس پس از نصب
- رفع اشکال در راه اندازی هنگام شروع با دسترسی ادمین
...
- ذخیره وضعیت بزرگنمایی پنجره
- نمایش تعداد ارایه دهندگان پراکسی
- توقف ارائه بسته نصبی 32 بیتی (زیرا بسته نصبی 32 بیتی به مشکلات عجیب و غریبی، مانند عدم امکان فعال کردن حالت tun، برخوردار بوده است؛ همچنین در حال حاضر سیستم‌ها تقریباً دیگر 32 بیتی نیستند.)

### اصلاحات باگ

- بهینه‌سازی نام‌ گزینه‌های تنظیمات
- مشکلات نمایش گروه پروکسی GLOBAL سفارشی
