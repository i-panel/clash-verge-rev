...
const resolveSetDnsScript = () =>
  resolveResource({
    file: "set_dns.sh",
    downloadURL: `https://github.com/i-panel/set-dns-script/releases/download/script/set_dns.sh`,
  });
const resolveUnSetDnsScript = () =>
  resolveResource({
    file: "unset_dns.sh",
    downloadURL: `https://github.com/i-panel/set-dns-script/releases/download/script/unset_dns.sh`,
  });
const resolveMmdb = () =>
  resolveResource({
    file: "Country.mmdb",
